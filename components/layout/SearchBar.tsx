                        ...
                        {results.length > 0 ? (
                            results.map((match, index) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 p-4 transition-colors text-left group/item ${activeIndex === index ? 'bg-white/10 ring-1 ring-white/20' : 'hover:bg-white/5'}`}
                                >
