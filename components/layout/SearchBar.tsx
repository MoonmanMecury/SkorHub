                        ...
                        {results.length > 0 ? (
                            results.map((match, index) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 p-4 transition-colors text-left group/item relative border-l-2 ${activeIndex === index ? 'bg-primary/10 border-primary' : 'hover:bg-white/5 border-l-transparent'}`}
                                >
