    ...
    return (
        <div className="flex-1 max-w-md relative" ref={dropdownRef}>
            <div className={`relative group transition-all duration-300 ${isOpen ? 'scale-[1.02]' : ''}`}>
                ...
                <input
                    className={`w-full bg-[#161618] border rounded-2xl py-2.5 pl-12 pr-4 text-xs font-medium focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none focus:border-primary/50 transition-all text-white placeholder-slate-600 outline-none ${isOpen ? 'border-primary/30 shadow-lg shadow-primary/5' : 'border-white/5'}`}
