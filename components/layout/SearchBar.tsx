                        ...
                        {results.length > 0 ? (
                            results.map((match) => (
                                <button
                                    ...
                                    aria-label={`View match between ${match.teams?.home?.name} and ${match.teams?.away?.name}`}
                                    className="w-full flex items-center gap-4 p-4 hover:bg-white/5 transition-colors text-left group/item focus:bg-white/5 outline-none focus:ring-inset focus:ring-1 focus:ring-primary/50"
                                >
