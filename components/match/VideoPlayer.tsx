            ...
            <div className="absolute top-4 right-4 flex gap-1 z-20 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                {[
                    ...
                    <button
                        ...
                        className={`relative group/btn w-8 h-8 rounded-full font-black text-[8px] flex items-center justify-center backdrop-blur-md transition-all border focus-visible:ring-2 focus-visible:ring-primary focus-visible:opacity-100 outline-none ${streamQuality === option.quality
