                ...
                <div className="glass p-5 rounded-2xl border border-white/5 bg-[#161618]/80 shadow-2xl flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-4 border-t border-white/5">
                        <button
                            ...
                            aria-pressed={isFav}
                            className={`flex flex-col items-center justify-center p-4 rounded-xl transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isFav
