                ...
                <div className="glass p-5 rounded-2xl border border-white/5 bg-[#161618]/80 shadow-2xl flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-2 gap-2 pt-4 border-t border-white/5">
                        <button
                            ...
                            className={`flex flex-col items-center justify-center p-4 rounded-xl transition-all border focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${isFav
                        ...
                        <div className="relative group/share">
                            <button
                                ...
                                className="w-full h-full flex flex-col items-center justify-center p-4 rounded-xl bg-white/5 border border-transparent text-slate-500 hover:bg-white/10 transition-all focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                            >
