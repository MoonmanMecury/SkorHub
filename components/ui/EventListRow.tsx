        ...
        <div className="group relative bg-[#161618]/40 hover:bg-[#161618] border border-white/5 hover:border-primary/20 rounded-2xl p-4 transition-all duration-300">
            <Link href={`/match/${id}`} className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="px-6 py-2 bg-white/5 group-hover:bg-primary border border-white/10 group-hover:border-primary text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all">
                        Watch
                    </div>
                </div>
            </Link>
            ...
            <button
                ...
                aria-pressed={isFav}
                className={`absolute -right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-lg border flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 group-hover:translate-x-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${isFav ? 'bg-primary text-white border-primary/50 opacity-100 translate-x-2' : 'bg-[#0A0A0B] text-slate-500 border-white/10 hover:border-primary/50 hover:text-white backdrop-blur-md'
                    }`}
            >
                <span
