        ...
        <div className="group relative bg-[#161618]/40 hover:bg-[#161618] border border-white/5 hover:border-primary/20 rounded-2xl p-4 transition-all duration-300">
            <Link href={`/match/${id}`} className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <span className="px-6 py-2 bg-white/5 group-hover:bg-primary border border-white/10 group-hover:border-primary text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all inline-block">
                        Watch
                    </span>
                </div>
            </Link>
