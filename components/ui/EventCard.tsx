    ...
    return (
        <div className="block group relative">
            ...
            <button
                ...
                className={`absolute top-2.5 right-2.5 w-7 h-7 rounded-xl border flex items-center justify-center transition-all z-20 focus-visible:ring-2 focus-visible:ring-primary outline-none ${isFav
