    ...
    return (
        <div className="w-full group relative block">
            ...
            <button
                ...
                className={`absolute bottom-16 right-4 z-30 w-10 h-10 rounded-2xl flex items-center justify-center transition-all shadow-2xl border focus-visible:opacity-100 outline-none focus-visible:ring-2 focus-visible:ring-primary ${isFav
