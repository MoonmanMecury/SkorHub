    ...
    return (
        <div className="w-full group relative block">
            ...
            <button
                ...
                className={`absolute bottom-16 right-4 z-30 w-10 h-10 rounded-2xl flex items-center justify-center transition-all shadow-2xl border focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none ${isFav
                    ? 'bg-primary text-white border-primary/50'
                    : 'bg-black/60 text-white/50 border-white/10 hover:border-primary/50 hover:text-white backdrop-blur-md opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100'
                    }`}
            >
