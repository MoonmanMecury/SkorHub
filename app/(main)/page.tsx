...
export default async function Home() {
    // Parallelize data fetching to eliminate waterfall and reduce TTFB
    ...
    // Use a Set for O(1) lookup during filtering, optimizing from O(N*M) to O(N+M)
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 pt-2 pb-10 space-y-12">
            ...
            <section>
                ...
                {/* Reuse already fetched sports data to avoid redundant API calls in child component */}
