...
export default async function Home() {
    // Parallelize data fetching to reduce TTFB and improve performance
    ...
    // Group matches by category for efficient rendering in sport-specific sections
    ...
    // Optimize upcoming matches calculation using a Set for O(1) lookup
