...
export default async function Home() {
    // Parallelize data fetching to reduce server-side latency and improve TTFB
    ...
    // Pre-calculate upcoming matches using a Set for O(1) lookup to avoid O(N*M) nested search
