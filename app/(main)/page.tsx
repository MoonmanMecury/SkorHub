...
export default async function Home() {
    // Parallelize data fetching to avoid network waterfalls and improve TTFB
    ...
    const matchesByCategory = allMatches.reduce((acc: { [key: string]: import('@/types').Match[] }, match) => {
