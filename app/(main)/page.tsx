...
export default async function Home() {
    // Parallelize data fetching to reduce TTFB by eliminating the await waterfall
    ...
    // Group matches by category with explicit type for better performance and safety
    ...
    // Use a Set for O(1) lookups instead of nested .find() calls (O(N*M))
