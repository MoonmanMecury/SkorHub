...
export default async function Home() {
    // Parallelize data fetching to reduce TTFB and avoid network waterfalls
    ...
    // Prepare upcoming matches (excluding currently live ones)
    // Use a Set for O(1) lookup during filtering to avoid O(N*M) complexity
