...
export default async function Home() {
    // ⚡ BOLT OPTIMIZATION: Parallelize data fetching to eliminate waterfall (saves ~500ms+)
    ...
    // ⚡ BOLT OPTIMIZATION: Use a Set for O(1) lookup during filtering (O(N+M) total vs O(N*M))
