...
export default async function Home() {
    // Parallelize data fetching to eliminate waterfall
    // Expected impact: Reduces TFB (Time to First Byte) by overlapping network latency
    ...
    // Create a Set for O(1) lookup during filtering of upcoming matches
    // This reduces the complexity of excluding live matches from O(N*M) to O(N+M)
