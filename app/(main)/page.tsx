...
export default async function Home() {
    // Parallelize data fetching to reduce total wait time
    ...
    // Use a Set for O(1) lookup when filtering matches
    ...
    // Filter upcoming matches using the liveMatchIds Set
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 pt-2 pb-10 space-y-12">
            ...
            <section>
                ...
                {/* Passing fetched sports prevents redundant fallback fetching within the component */}
