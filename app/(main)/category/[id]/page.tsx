...
export default async function CategoryPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Fetch sports and category-specific matches in parallel to avoid request waterfalls.
    // Using getMatchesBySport instead of filtering allMatches reduces network payload and CPU processing.
