...
export default async function CategoryPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Parallelize sports (for name lookup) and sport-specific matches fetch
    // Using getMatchesBySport instead of getAllMatches reduces data transfer and server-side filtering
