...
export default async function CategoryPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Parallelize fetching sports and specialized matches for this sport
    // This avoids fetching ALL matches and filtering manually, and eliminates the waterfall.
