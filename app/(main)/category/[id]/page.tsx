...
export default async function CategoryPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Parallelize sports and matches fetching to reduce page load time.
    // Use getMatchesBySport for granular, more efficient data fetching instead of filtering all matches.
